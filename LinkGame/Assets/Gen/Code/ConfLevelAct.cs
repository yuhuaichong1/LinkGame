...
public sealed partial class ConfLevelAct :  Bright.Config.BeanBase 
{
    public ConfLevelAct(ByteBuf _buf) 
    {
        Sn = _buf.ReadInt();
    ...
    public static ConfLevelAct DeserializeConfLevelAct(ByteBuf _buf)
    {
        return new ConfLevelAct(_buf);
    }
    ...
    public const int __ID__ = 575048146;
    ...
    public void Reload(ConfLevelAct reloadData)
    {
        Sn = reloadData.Sn;
