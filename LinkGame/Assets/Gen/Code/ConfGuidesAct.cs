...
public sealed partial class ConfGuidesAct :  Bright.Config.BeanBase 
{
    public ConfGuidesAct(ByteBuf _buf) 
    {
        Sn = _buf.ReadInt();
    ...
    public static ConfGuidesAct DeserializeConfGuidesAct(ByteBuf _buf)
    {
        return new ConfGuidesAct(_buf);
    }
    ...
    public const int __ID__ = 227872055;
    ...
    public void Reload(ConfGuidesAct reloadData)
    {
        Sn = reloadData.Sn;
