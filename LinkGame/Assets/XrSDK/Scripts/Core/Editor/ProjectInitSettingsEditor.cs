...
namespace XrSDK
{
    ...
    public class ProjectInitSettingsEditor : Editor
    {
        ...
        private static string DEFAULT_PROJECT_INIT_SETTINGS_PATH = "Assets/XrSDK/Resources/Settings/Project Init Settings.asset";
        ...
        private void InitCoreModules()
        {
            ...
            BaseModulePendant[] coreModules = projectInitSettings.CoreModules;
        ...
        {
            EditorGUILayout.BeginVertical(EditorCustomStyles.Instance.Skin.box);
