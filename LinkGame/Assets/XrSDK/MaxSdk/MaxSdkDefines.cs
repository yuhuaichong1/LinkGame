...
public static class MaxSdkDefines
{
    ...
    public static Action<string, ErrorCode> InterstitialFailedEvent;             //插屏广告加载失败
    public static Action<string, ErrorCode> InterstitialFailedToDisplayEvent;    //插屏广告显示失败，自动加载下一个广告
    ...
    public static Action<string, ErrorCode> RewardedAdFailedEvent;                          //激励视频加载失败
    public static Action<string, ErrorCode> RewardedAdFailedToDisplayEvent;                 //激励视频显示失败，建议加载下一个广告
